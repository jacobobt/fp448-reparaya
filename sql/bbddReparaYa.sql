...
--
-- Servidor: localhost
-- Temps de generació: 28-04-2026 a les 16:38:39
-- Versió del servidor: 8.0.45-0ubuntu0.24.04.1
-- Versió de PHP: 8.3.6
...
--
-- Base de dades: `wordpress5`
--

-- --------------------------------------------------------

--
-- Estructura de la taula `especialidades`
--
...
--
-- Bolcament de dades per a la taula `especialidades`
--

INSERT INTO `especialidades` (`id`, `nombre_especialidad`, `precio`) VALUES
(1, 'Fontanero', 25.00),
(2, 'Cerrajero', 30.00),
(3, 'Electricista', 5.00),
(4, 'Mecanico', 40.00),
...
CREATE TABLE `incidencias` (
  `id` int NOT NULL,
  `localizador` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  ...
  `tipo_urgencia` enum('Estandar','Urgente') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT 'Estandar',
...
INSERT INTO `incidencias` (`id`, `localizador`, `telefono_contacto`, `franja_horaria`, `cliente_id`, `tecnico_id`, `especialidad_id`, `descripcion`, `direccion`, `fecha_servicio`, `tipo_urgencia`, `estado`, `created_at`) VALUES
(1, 'REP-2026-0001', '111111111', '16:00-20:00', 3, 1, 1, 'Acaba de reventar una tuberia en mi ducha necesito reparacion URGENTE', 'calle alegria num 4', '2026-04-12 16:00:00', 'Urgente', 'Asignada', '2026-04-12 13:17:30'),
(2, 'REP-2026-0002', '676257812', '09:00-13:00', 7, 4, 2, 'Quiero cambiar la cerradura de mi garaje y necesito ayuda', 'Avenida buenas vivras 12, 5t,3a', '2026-04-17 09:00:00', 'Estandar', 'Asignada', '2026-04-12 14:31:37'),
(3, 'REP-2026-0003', '376842479', '09:00-13:00', 8, 2, 4, 'Quiero hacerle una inspeccion a mi coche antes de pasar por la ITV', 'Fondo de bikini 3 1,1', '2026-04-20 09:00:00', 'Estandar', 'Asignada', '2026-04-12 14:34:06'),
(4, 'REP-2026-0004', '610926031', '09:00-13:00', 9, 4, 3, 'Reparar ethernet', 'Girona', '2026-05-10 09:00:00', 'Estandar', 'Asignada', '2026-04-22 16:49:07');

-- --------------------------------------------------------

--
-- Estructura de la taula `tecnicos`
--
...
--
-- Bolcament de dades per a la taula `tecnicos`
--

INSERT INTO `tecnicos` (`id`, `usuario_id`, `nombre_completo`, `especialidad_id`, `disponible`) VALUES
(1, 1, 'Nacho Garcia Fontanero', 1, 1),
(2, 6, 'Juan Alberto Mecanico', 4, 1),
(3, 5, 'Paco Ruiz Electricista', 3, 0),
(4, 4, 'Marcos Gutierrez Cerrajero', 2, 1);
...
(1, 'Nacho Fontanero', 'nfontanero@reparaya.edu', '$2y$10$825asWbRyXYyvmy333eKlevF./e/ukpIHM531g75/v8z3VPq743KK', 'tecnico', '999999998', '2026-04-11 05:38:42'),
(2, 'Admin', 'admin@reparaya.edu', '$2y$10$O6OC2V6G0VSvei/4on0Joe/M1v7pGVFVmObQuNiaCI7qV.KrLbVBu', 'admin', '111223344', '2026-04-11 05:38:43'),
(3, 'Antonia', 'antonia1965@gmail.com', '$2y$10$QFsBwmxLXkxESqdEm7vtT.m67HdHMIFVuk/fiBPVTUkGLp/d5CtfW', 'particular', '111111111', '2026-04-12 12:56:34'),
(4, 'Marcos Cerrajero', 'mcerrajero@reparaya.edu', '$2y$10$i/u0XhLSxccU5TE/N1h0tOIEYZ2pCDvf.r//hRGYJQUlFrSvPbr0O', 'tecnico', '999999999', '2026-04-12 14:19:22'),
(5, 'Paco Electricista', 'pelectricista@reparaya.edu', '$2y$10$/WIlq4mUHJLsvGHIX56TvOMWSaFae6sN2gTPSFVug0vV9SvlWmXaS', 'tecnico', '999999997', '2026-04-12 14:20:19'),
(6, 'Juan Mecanico', 'jmecanico@reparaya.edu', '$2y$10$ZgtBDl6FPA4k3Iikl2ini.J/zcuWcRgt/K0/IYFcaIc.TNxk8W02G', 'tecnico', '999999996', '2026-04-12 14:21:02'),
(7, 'Jacobo Perez', 'jperez@gmail.com', '$2y$10$a4n8uz38IHcC4x4bEEJpvejcduBYp0FgnVj/ZoSQk7aU/nhQmLIWS', 'particular', '616166116', '2026-04-12 14:23:28'),
(8, 'Marc Marquez', 'mmarquez@gmail.com', '$2y$10$ppt3dOtDi2Dk0T8Js0YQYONdqqwmgbIGbeymsiIGINycZeE4eqCBK', 'particular', '376842479', '2026-04-12 14:24:03'),
(9, 'Borja', 'bmulleras@uoc.edu', '$2y$10$CSRg.kxjSYY9SQDc7wHzmuwY6NZfTBQSAg.NKlglNv24qePr50SoK', 'particular', '610926031', '2026-04-22 16:47:06'),
(12, 'p', 'p@gmail.com', '$2y$10$gYq0wPQGAU/KMXVG/BtVdeLanjp63GTNJqA9S3ozRb8NQyFiXN25e', 'particular', '2222', '2026-04-27 15:50:53');
...
--
-- Bolcament de dades per a la taula `wp_comments`
--

INSERT INTO `wp_comments` (`comment_ID`, `comment_post_ID`, `comment_author`, `comment_author_email`, `comment_author_url`, `comment_author_IP`, `comment_date`, `comment_date_gmt`, `comment_content`, `comment_karma`, `comment_approved`, `comment_agent`, `comment_type`, `comment_parent`, `user_id`) VALUES
(1, 1, 'A WordPress Commenter', 'wapuu@wordpress.example', 'https://wordpress.org/', '', '2026-03-16 04:18:39', '2026-03-16 04:18:39', 'Hi, this is a comment.\nTo get started with moderating, editing, and deleting comments, please visit the Comments screen in the dashboard.\nCommenter avatars come from <a href=\"https://gravatar.com/\">Gravatar</a>.', 0, '1', '', 'comment', 0, 0);
...
--
-- Bolcament de dades per a la taula `wp_options`
--

INSERT INTO `wp_options` (`option_id`, `option_name`, `option_value`, `autoload`) VALUES
(1, 'cron', 'a:10:{i:1775906439;a:1:{s:34:\"wp_privacy_delete_old_export_files\";a:1:{s:32:\"40cd750bba9870f18aada2478b24840a\";a:3:{s:8:\"schedule\";s:6:\"hourly\";s:4:\"args\";a:0:{}s:8:\"interval\";i:3600;}}}i:1775924476;a:1:{s:21:\"wp_update_user_counts\";a:1:{s:32:\"40cd750bba9870f18aada2478b24840a\";a:3:{s:8:\"schedule\";s:10:\"twicedaily\";s:4:\"args\";a:0:{}s:8:\"interval\";i:43200;}}}i:1775927918;a:1:{s:16:\"wp_version_check\";a:1:{s:32:\"40cd750bba9870f18aada2478b24840a\";a:3:{s:8:\"schedule\";s:10:\"twicedaily\";s:4:\"args\";a:0:{}s:8:\"interval\";i:43200;}}}i:1775929718;a:1:{s:17:\"wp_update_plugins\";a:1:{s:32:\"40cd750bba9870f18aada2478b24840a\";a:3:{s:8:\"schedule\";s:10:\"twicedaily\";s:4:\"args\";a:0:{}s:8:\"interval\";i:43200;}}}i:1775931518;a:1:{s:16:\"wp_update_themes\";a:1:{s:32:\"40cd750bba9870f18aada2478b24840a\";a:3:{s:8:\"schedule\";s:10:\"twicedaily\";s:4:\"args\";a:0:{}s:8:\"interval\";i:43200;}}}i:1775967639;a:1:{s:32:\"recovery_mode_clean_expired_keys\";a:1:{s:32:\"40cd750bba9870f18aada2478b24840a\";a:3:{s:8:\"schedule\";s:5:\"daily\";s:4:\"args\";a:0:{}s:8:\"interval\";i:86400;}}}i:1775967676;a:2:{s:19:\"wp_scheduled_delete\";a:1:{s:32:\"40cd750bba9870f18aada2478b24840a\";a:3:{s:8:\"schedule\";s:5:\"daily\";s:4:\"args\";a:0:{}s:8:\"interval\";i:86400;}}s:25:\"delete_expired_transients\";a:1:{s:32:\"40cd750bba9870f18aada2478b24840a\";a:3:{s:8:\"schedule\";s:5:\"daily\";s:4:\"args\";a:0:{}s:8:\"interval\";i:86400;}}}i:1775967678;a:1:{s:30:\"wp_scheduled_auto_draft_delete\";a:1:{s:32:\"40cd750bba9870f18aada2478b24840a\";a:3:{s:8:\"schedule\";s:5:\"daily\";s:4:\"args\";a:0:{}s:8:\"interval\";i:86400;}}}i:1776140439;a:1:{s:30:\"wp_site_health_scheduled_check\";a:1:{s:32:\"40cd750bba9870f18aada2478b24840a\";a:3:{s:8:\"schedule\";s:6:\"weekly\";s:4:\"args\";a:0:{}s:8:\"interval\";i:604800;}}}s:7:\"version\";i:2;}', 'on'),
(2, 'siteurl', 'https://fp064.techlab.uoc.edu/~uocx5/', 'on'),
(3, 'home', 'https://fp064.techlab.uoc.edu/~uocx5/', 'on'),
(4, 'blogname', 'Proyecto MCVMasters', 'on'),
...
(92, 'admin_email_lifespan', '1789186718', 'on'),
...
(167, '_site_transient_timeout_php_check_76d2cd2a5eb29facccd351abf19ed9c8', '1776509437', 'off'),
(168, '_site_transient_php_check_76d2cd2a5eb29facccd351abf19ed9c8', 'a:5:{s:19:\"recommended_version\";s:3:\"8.3\";s:15:\"minimum_version\";s:6:\"7.2.24\";s:12:\"is_supported\";b:1;s:9:\"is_secure\";b:1;s:13:\"is_acceptable\";b:1;}', 'off');
...
--
-- Bolcament de dades per a la taula `wp_postmeta`
--
...
--
-- Bolcament de dades per a la taula `wp_posts`
--

INSERT INTO `wp_posts` (`ID`, `post_author`, `post_date`, `post_date_gmt`, `post_content`, `post_title`, `post_excerpt`, `post_status`, `comment_status`, `ping_status`, `post_password`, `post_name`, `to_ping`, `pinged`, `post_modified`, `post_modified_gmt`, `post_content_filtered`, `post_parent`, `guid`, `menu_order`, `post_type`, `post_mime_type`, `comment_count`) VALUES
(1, 1, '2026-03-16 04:18:39', '2026-03-16 04:18:39', '<!-- wp:paragraph -->\n<p>Welcome to WordPress. This is your first post. Edit or delete it, then start writing!</p>\n<!-- /wp:paragraph -->', 'Hello world!', '', 'publish', 'open', 'open', '', 'hello-world', '', '', '2026-03-16 04:18:39', '2026-03-16 04:18:39', '', 0, 'https://fp064.techlab.uoc.edu/~uocx5//?p=1', 0, 'post', '', 1),
(2, 1, '2026-03-16 04:18:39', '2026-03-16 04:18:39', '<!-- wp:paragraph -->\n<p>This is an example page. It\'s different from a blog post because it will stay in one place and will show up in your site navigation (in most themes). Most people start with an About page that introduces them to potential site visitors. It might say something like this:</p>\n<!-- /wp:paragraph -->\n\n<!-- wp:quote -->\n<blockquote class=\"wp-block-quote\">\n<!-- wp:paragraph -->\n<p>Hi there! I\'m a bike messenger by day, aspiring actor by night, and this is my website. I live in Los Angeles, have a great dog named Jack, and I like pi&#241;a coladas. (And gettin\' caught in the rain.)</p>\n<!-- /wp:paragraph -->\n</blockquote>\n<!-- /wp:quote -->\n\n<!-- wp:paragraph -->\n<p>...or something like this:</p>\n<!-- /wp:paragraph -->\n\n<!-- wp:quote -->\n<blockquote class=\"wp-block-quote\">\n<!-- wp:paragraph -->\n<p>The XYZ Doohickey Company was founded in 1971, and has been providing quality doohickeys to the public ever since. Located in Gotham City, XYZ employs over 2,000 people and does all kinds of awesome things for the Gotham community.</p>\n<!-- /wp:paragraph -->\n</blockquote>\n<!-- /wp:quote -->\n\n<!-- wp:paragraph -->\n<p>As a new WordPress user, you should go to <a href=\"https://fp064.techlab.uoc.edu/~uocx5//wp-admin/\">your dashboard</a> to delete this page and create new pages for your content. Have fun!</p>\n<!-- /wp:paragraph -->', 'Sample Page', '', 'publish', 'closed', 'open', '', 'sample-page', '', '', '2026-03-16 04:18:39', '2026-03-16 04:18:39', '', 0, 'https://fp064.techlab.uoc.edu/~uocx5//?page_id=2', 0, 'page', '', 0),
(3, 1, '2026-03-16 04:18:39', '2026-03-16 04:18:39', '<!-- wp:heading -->\n<h2 class=\"wp-block-heading\">Who we are</h2>\n<!-- /wp:heading -->\n<!-- wp:paragraph -->\n<p><strong class=\"privacy-policy-tutorial\">Suggested text: </strong>Our website address is: https://fp064.techlab.uoc.edu/~uocx5/.</p>\n<!-- /wp:paragraph -->\n<!-- wp:heading -->\n<h2 class=\"wp-block-heading\">Comments</h2>\n<!-- /wp:heading -->\n<!-- wp:paragraph -->\n<p><strong class=\"privacy-policy-tutorial\">Suggested text: </strong>When visitors leave comments on the site we collect the data shown in the comments form, and also the visitor&#8217;s IP address and browser user agent string to help spam detection.</p>\n<!-- /wp:paragraph -->\n<!-- wp:paragraph -->\n<p>An anonymized string created from your email address (also called a hash) may be provided to the Gravatar service to see if you are using it. The Gravatar service privacy policy is available here: https://automattic.com/privacy/. After approval of your comment, your profile picture is visible to the public in the context of your comment.</p>\n<!-- /wp:paragraph -->\n<!-- wp:heading -->\n<h2 class=\"wp-block-heading\">Media</h2>\n<!-- /wp:heading -->\n<!-- wp:paragraph -->\n<p><strong class=\"privacy-policy-tutorial\">Suggested text: </strong>If you upload images to the website, you should avoid uploading images with embedded location data (EXIF GPS) included. Visitors to the website can download and extract any location data from images on the website.</p>\n<!-- /wp:paragraph -->\n<!-- wp:heading -->\n<h2 class=\"wp-block-heading\">Cookies</h2>\n<!-- /wp:heading -->\n<!-- wp:paragraph -->\n<p><strong class=\"privacy-policy-tutorial\">Suggested text: </strong>If you leave a comment on our site you may opt-in to saving your name, email address and website in cookies. These are for your convenience so that you do not have to fill in your details again when you leave another comment. These cookies will last for one year.</p>\n<!-- /wp:paragraph -->\n<!-- wp:paragraph -->\n<p>If you visit our login page, we will set a temporary cookie to determine if your browser accepts cookies. This cookie contains no personal data and is discarded when you close your browser.</p>\n<!-- /wp:paragraph -->\n<!-- wp:paragraph -->\n<p>When you log in, we will also set up several cookies to save your login information and your screen display choices. Login cookies last for two days, and screen options cookies last for a year. If you select &quot;Remember Me&quot;, your login will persist for two weeks. If you log out of your account, the login cookies will be removed.</p>\n<!-- /wp:paragraph -->\n<!-- wp:paragraph -->\n<p>If you edit or publish an article, an additional cookie will be saved in your browser. This cookie includes no personal data and simply indicates the post ID of the article you just edited. It expires after 1 day.</p>\n<!-- /wp:paragraph -->\n<!-- wp:heading -->\n<h2 class=\"wp-block-heading\">Embedded content from other websites</h2>\n<!-- /wp:heading -->\n<!-- wp:paragraph -->\n<p><strong class=\"privacy-policy-tutorial\">Suggested text: </strong>Articles on this site may include embedded content (e.g. videos, images, articles, etc.). Embedded content from other websites behaves in the exact same way as if the visitor has visited the other website.</p>\n<!-- /wp:paragraph -->\n<!-- wp:paragraph -->\n<p>These websites may collect data about you, use cookies, embed additional third-party tracking, and monitor your interaction with that embedded content, including tracking your interaction with the embedded content if you have an account and are logged in to that website.</p>\n<!-- /wp:paragraph -->\n<!-- wp:heading -->\n<h2 class=\"wp-block-heading\">Who we share your data with</h2>\n<!-- /wp:heading -->\n<!-- wp:paragraph -->\n<p><strong class=\"privacy-policy-tutorial\">Suggested text: </strong>If you request a password reset, your IP address will be included in the reset email.</p>\n<!-- /wp:paragraph -->\n<!-- wp:heading -->\n<h2 class=\"wp-block-heading\">How long we retain your data</h2>\n<!-- /wp:heading -->\n<!-- wp:paragraph -->\n<p><strong class=\"privacy-policy-tutorial\">Suggested text: </strong>If you leave a comment, the comment and its metadata are retained indefinitely. This is so we can recognize and approve any follow-up comments automatically instead of holding them in a moderation queue.</p>\n<!-- /wp:paragraph -->\n<!-- wp:paragraph -->\n<p>For users that register on our website (if any), we also store the personal information they provide in their user profile. All users can see, edit, or delete their personal information at any time (except they cannot change their username). Website administrators can also see and edit that information.</p>\n<!-- /wp:paragraph -->\n<!-- wp:heading -->\n<h2 class=\"wp-block-heading\">What rights you have over your data</h2>\n<!-- /wp:heading -->\n<!-- wp:paragraph -->\n<p><strong class=\"privacy-policy-tutorial\">Suggested text: </strong>If you have an account on this site, or have left comments, you can request to receive an exported file of the personal data we hold about you, including any data you have provided to us. You can also request that we erase any personal data we hold about you. This does not include any data we are obliged to keep for administrative, legal, or security purposes.</p>\n<!-- /wp:paragraph -->\n<!-- wp:heading -->\n<h2 class=\"wp-block-heading\">Where your data is sent</h2>\n<!-- /wp:heading -->\n<!-- wp:paragraph -->\n<p><strong class=\"privacy-policy-tutorial\">Suggested text: </strong>Visitor comments may be checked through an automated spam detection service.</p>\n<!-- /wp:paragraph -->\n', 'Privacy Policy', '', 'draft', 'closed', 'open', '', 'privacy-policy', '', '', '2026-03-16 04:18:39', '2026-03-16 04:18:39', '', 0, 'https://fp064.techlab.uoc.edu/~uocx5//?page_id=3', 0, 'page', '', 0),
(5, 1, '2026-03-16 04:21:35', '2026-03-16 04:21:35', '<!-- wp:page-list /-->', 'Navigation', '', 'publish', 'closed', 'closed', '', 'navigation', '', '', '2026-03-16 04:21:35', '2026-03-16 04:21:35', '', 0, 'https://fp064.techlab.uoc.edu/~uocx5//?p=5', 0, 'wp_navigation', '', 0);
...
--
-- Bolcament de dades per a la taula `wp_terms`
--
...
--
-- Bolcament de dades per a la taula `wp_term_relationships`
--
...
--
-- Bolcament de dades per a la taula `wp_term_taxonomy`
--
...
--
-- Bolcament de dades per a la taula `wp_usermeta`
--
...
(16, 1, 'session_tokens', 'a:1:{s:64:\"5c004b006a9e7c599f5e4c92747f2b5547bca4dd7aa1884f2f08531f8b064a1a\";a:4:{s:10:\"expiration\";i:1773807675;s:2:\"ip\";s:10:\"172.19.0.1\";s:2:\"ua\";s:111:\"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/145.0.0.0 Safari/537.36\";s:5:\"login\";i:1773634875;}}'),
...
--
-- Bolcament de dades per a la taula `wp_users`
--

INSERT INTO `wp_users` (`ID`, `user_login`, `user_pass`, `user_nicename`, `user_email`, `user_url`, `user_registered`, `user_activation_key`, `user_status`, `display_name`) VALUES
(1, 'admin', '$wp$2y$12$jaBBgOurMtAeShc4Qlh03OppkOQQXVIxGUwGk1bY5C2edsOfdxaJ2', 'admin', 'admin@gmail.com', 'http://localhost:8082/wordpress', '2026-03-16 04:18:38', '', 0, 'admin');
...
--
-- Índexs per a la taula `especialidades`
--
...
--
-- Índexs per a la taula `tecnicos`
--
...
--
-- Índexs per a la taula `wp_commentmeta`
--
...
--
-- Índexs per a la taula `wp_comments`
--
...
--
-- Índexs per a la taula `wp_links`
--
...
--
-- Índexs per a la taula `wp_options`
--
...
--
-- Índexs per a la taula `wp_postmeta`
--
...
--
-- Índexs per a la taula `wp_posts`
--
...
--
-- Índexs per a la taula `wp_termmeta`
--
...
--
-- Índexs per a la taula `wp_terms`
--
...
--
-- Índexs per a la taula `wp_term_relationships`
--
...
--
-- Índexs per a la taula `wp_term_taxonomy`
--
...
--
-- Índexs per a la taula `wp_usermeta`
--
...
--
-- Índexs per a la taula `wp_users`
--
...
--
-- AUTO_INCREMENT per la taula `especialidades`
--
ALTER TABLE `especialidades`
...
--
-- AUTO_INCREMENT per la taula `tecnicos`
--
ALTER TABLE `tecnicos`
  MODIFY `id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
-- AUTO_INCREMENT per la taula `wp_commentmeta`
--
ALTER TABLE `wp_commentmeta`
  MODIFY `meta_id` bigint UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT per la taula `wp_comments`
--
ALTER TABLE `wp_comments`
  MODIFY `comment_ID` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT per la taula `wp_links`
--
ALTER TABLE `wp_links`
  MODIFY `link_id` bigint UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT per la taula `wp_options`
--
ALTER TABLE `wp_options`
  MODIFY `option_id` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=169;

--
-- AUTO_INCREMENT per la taula `wp_postmeta`
--
ALTER TABLE `wp_postmeta`
  MODIFY `meta_id` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT per la taula `wp_posts`
--
ALTER TABLE `wp_posts`
  MODIFY `ID` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT per la taula `wp_termmeta`
--
ALTER TABLE `wp_termmeta`
  MODIFY `meta_id` bigint UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT per la taula `wp_terms`
--
ALTER TABLE `wp_terms`
  MODIFY `term_id` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT per la taula `wp_term_taxonomy`
--
ALTER TABLE `wp_term_taxonomy`
  MODIFY `term_taxonomy_id` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT per la taula `wp_usermeta`
--
ALTER TABLE `wp_usermeta`
  MODIFY `umeta_id` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;

--
-- AUTO_INCREMENT per la taula `wp_users`
--
ALTER TABLE `wp_users`
...
--
-- Restriccions per a la taula `tecnicos`
--
ALTER TABLE `tecnicos`
