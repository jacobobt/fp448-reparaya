...
class GestoraPanelController extends Controller
{
    ...
    {
        $gestora = $this->getGestoraAutorizada();

        $comunidades = $gestora->comunidades()->with('zona')->orderBy('nombre')->get();
    ...
    // -------------------------------------------------------
    // Método privado reutilizable — elimina la repetición de
    // código de autorización que había en cada método
    // -------------------------------------------------------
    private function getGestoraAutorizada()
    {
